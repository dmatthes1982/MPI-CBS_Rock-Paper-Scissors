...
phaseMark = generalDefinitions.phaseMark;                                   % extract condition identifiers
...
part = listdlg('PromptString',' Select phases...', ...                      % open the dialog window --> the user can select the conditions of interest
...
cellfun(@(x) fprintf('%s, ', x), phaseMark, 'UniformOutput', false);         % show the identifiers of the selected conditions in the command window
fprintf('\b\b.\n\n');
...
clear cell_array passband phaseMark connections headline numOfCond
