...
%   cfg.desFolder   = destination folder (default: '/data/pt_01843/eegData/DualEEG_RPS_processedDataOld/01_raw/')
...
% Get config options
% -------------------------------------------------------------------------
desFolder   = ft_getopt(cfg, 'desFolder', '/data/pt_01843/eegData/DualEEG_RPS_processedDataOld/01_raw/');
