...
switch type
  case 'settings'
    T = table(1,{'unknown'},{'unknown'},{'unknown'},{'unknown'}, ...
              ...
              {'unknown'},{'unknown'});
    T.Properties.VariableNames = {'dyad', 'noiChan', 'bChanFPp1', ...
                                  'bChanFPp2', 'bChanPDp1', 'bChanPDp2',...
                                  'bChanPSp1','bChanPSp2', 'bChanCp1', ...
                                  'bChanCp2', 'reference', 'bandpass', ...
                                  'lineNoiseFilt', 'ICAcorrVal1', ...
                                  'ICAcorrVal2', 'ICAcompFPp1', ...
                                  'ICAcompFPp2', 'ICAcompPDp1', ...
                                  'ICAcompPDp2', 'ICAcompPSp1', ...
                                  'ICAcompPSp2', 'ICAcompCp1', ...
                                  'ICAcompCp2', 'artMethod', ...
                                  'artThreshold', 'rejectBadCycles', ...
