...
%   cfg.path      = source path' (i.e. '/data/pt_01843/eegData/DualEEG_RPS_processedData/08a_tfr/')
...
path      = ft_getopt(cfg, 'path', ...
              '/data/pt_01843/eegData/DualEEG_RPS_processedData/08_tfr/');
...
for i=1:1:numOfDyads
  ...
  for j=1:1:4
    ...
    [tfr_tmp{j,k}, trialSpec{j,k}] = fixTrialOrder( tfr_tmp{j,k}, ...
                   trialinfo_tmp{j,k}, generalDefinitions.phaseNum{j}, i, ...
                   k, j);
    end
