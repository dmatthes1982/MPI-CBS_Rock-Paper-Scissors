...
data.FP.part1 = reref(cfg, data.FP.part1);

fprintf('Condition PredDiff...\n');
data.PD.part1 = reref(cfg, data.PD.part1);

fprintf('Condition PredSame...\n');
data.PS.part1 = reref(cfg, data.PS.part1);

fprintf('Condition Control...\n');
data.C.part1  = reref(cfg, data.C.part1);

fprintf('<strong>Re-reference data of participant 2...</strong>\n');
fprintf('Condition FreePlay...\n');
data.FP.part2 = reref(cfg, data.FP.part2);

fprintf('Condition PredDiff...\n');
data.PD.part2 = reref(cfg, data.PD.part2);

fprintf('Condition PredSame...\n');
data.PS.part2 = reref(cfg, data.PS.part2);

fprintf('Condition Control...\n');
data.C.part2  = reref(cfg, data.C.part2);
