...
if pwelch == true
  ...
  for i = numOfPart
    ...
    data_eyecor = RPS_segmentation( cfg, data_eyecor );
    ...
    if artifactRejection == true
      if artifactAvailable == true
        ...
        data_eyecor = RPS_rejectArtifacts(cfg, data_eyecor);
        fprintf('\n');
      end
    ...
    data_eyecor = RPS_pWelch( cfg, data_eyecor );                           % calculate power spectral density using Welch's method
