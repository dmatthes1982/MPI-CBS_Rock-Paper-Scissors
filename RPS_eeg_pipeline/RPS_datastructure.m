...
% follows:
%
% Every step of the data processing pipeline (i.e. 01a_raw, 01b_manart,
% 02a_badchan, 02b_preproc1 ...) produces output of N single *.mat files,
% where N describes the current number of dyads within the study. Each
% *.mat file holds a 'data' struct consisting of four fields, which are
% labeled with FP, PD, PS and  C. Theses are the leading letters of the
% four existing conditions 'FreePlay', 'PredictDifferent', 'PredictSame'
% and 'Control'. Each condition field again comprises two subfields named
% part1 and part2, which are 1x1 structures with the complete data of the
% condition-associated data of one participant. The data is stored for each
