function RPS_easyTotalPowerBarPlot( cfg, data )
% RPS_EASYTOTALPOWERBARPLOT shows the total power of all available
% channels. The channels are ordered in ascending order and outliers are
% highlighted.
% 
% Use as
%   RPS_easyTotalPowerBarPlot( cfg, data)
%
% where the input has to be a result of RPS_SELECTBADCHAN.
%
...
%
% See also RPS_SELECTBADCHAN, RPS_DATASTRUCTURE
